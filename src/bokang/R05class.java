...
public class R05class {
	...
	public static void main(String[] args) {
		...
		잘못된방법]
			...
			123_456_
			_123_456
			위와 같이 언더바로 시작하거나 끝날수 없고, 소수점과
			연결해서도 사용할 수 없다.
		 */
		//체크카드 클래스 Ver 01
		CheckCard1 cc1 = new CheckCard1();
		cc1.cardNumber = 1123_2425_3237_6744L;
		cc1.owner = "홍길동";
		cc1.balace = 10000;
		cc1.point = 0;
		...
		cc1.showState(); // 상태를 보면 마이너스 금액이 출력된다.(논리적 오류)
		cc1.balace = 10000000; // 입금처리 없이 잔고의 변경이 가능하다. (논리적 오류)

		
		///////////////////////////////////////////////////////////////////////
		
		//체크카드 클래스 Ver02
		CheckCard2 cc2 = new CheckCard2(); // 빈 객체 생성한 후 ...
		cc2.initMembers(9999_8888_7777_6666L, "유비", 3000, 0); //객체 초기화...
		cc2.charge(4000);
		cc2.payment(9000);
		cc2.showState();
		
		//멤버변수가 private으로 정보은닉 되었으므로 직접 접근 불가능
		...
		CheckCard3 cc3 = new CheckCard3(2222_4444_8888_5555L, "관우", 10000, 0);
