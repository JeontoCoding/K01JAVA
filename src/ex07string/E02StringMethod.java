...
public class E02StringMethod {
	...
	public static void main(String[] args) {
		...
		/*
		10] indexOf() : 문자열에서 특정 문자열을 시작인덱스를 반환한다.
		...
		/*
		13] split : 문자열을 구분자를 통해 분리해서 String 타입의 배열로
		...
		/*
		14] substring() : 시작인덱스와 끝 인덱스 사이의 문자열을 잘라서
			반환해준다.
			사용1 : substring(인덱스) 이 경우 인덱스부터 끝까지 잘라낸다.
			사용2 : substring(시작인덱스, 끝인덱스) => 인덱스에 해당되는 부분만
				잘라서 반환한다.
		 */
