...
class FruitSeller3{
	...
	/*
		...
		일반 멤버메서드에서는 초기화 할수 없다
		하지만 생성자는 객체생성시 딱 한번만 호출되고, 개발자가 마음대로
		호출 할수 없으므로 한번 이상 초기화 되지않음이 보장된다.
		따라서 멤버상수는 생성자에서 초기화 할수 있다.
	 */
	...
	public int saleAppler(int money) {
...
class FruitBuyer3 {
	...
	public void buyApple(FruitSeller3 seller, int money) {
		numOfApple += seller.saleAppler(money);
		myMoney -= money;
	}
