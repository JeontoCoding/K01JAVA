...
-객체 생성은 할 수 없으나 그외 참조변수, 상속 등의 모든 기능을
	할 수 있다.
	
추상메서드
-오버라이딩의 목적으로 제작된다.
-메서드의 실행부가 없기떄문에 중괄호 {} 대신에 ; 을 을 붙여준다.
 */
...
/*
DTO(Data Transfer Object) : 데이터를 저잘하고 전송하기 위한 용도의
...
class PersonInfoDTO {
	...
	/*
	gatter/setter메서드 : DTO객체에서 private 으로 선언된 멤버변수의
