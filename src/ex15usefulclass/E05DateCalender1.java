...
public class E05DateCalender1 {
	
	public static Date date;
	
	/*
	Calendar클래스를 통해 얻은 객체로 현재시간을 초로 반환받은 후
	날짜를 원하는 포맷의 날짜를 문자열로 반환한다.
	 */
	...
	public static String[] myDiffDate() throws ParseException {
		...
		long diffDays = diffSec / (24*60*60); //하루는 86400초 이므로 나눠서 일수를 계산한다.
	...
	public static void main(String[] args) throws ParseException {
		...
		System.out.println(myDateFormat(calendar, "오늘은 M월의 W번째 주, d번째날, F번째 E요일"));
