...
-데이터의 중복 저장이 허용된다.
-데이터의 저장 순서를 보장한다.
-테이터 접근시 get() 혹은 iterator()를 이용한다
...
public class Ex03ArrayList1 {
	...
	public static void main(String[] args) {
		...
		/*
		1-3] 리스트 컬렉션 출력하기(for, 확장for문) 출력하기
		...
		/*
		Iterator 사용법
		1.컬렉션에 저장된 내용을 Iterator 에게 알려주기 위해 객체를 
			생성한다.
		...
		/*
		방법 2 : indexOf()메서드로 인덱스를 확인한 후 삭제한다. 
		 */
		...
		/*
		방법 3 : 인스턴스(객체)의 참조값을 통해 삭제한다. 이 경우 삭제에
				 성공하면 true가 반환된다.
		 */
