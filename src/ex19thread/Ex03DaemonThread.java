...
독립쓰레드(Non Daemon Thread)
	: 메인쓰레드와 working쓰레그(개발자가 정의한 쓰레드)를 일컫는 것으로
...
public class Ex03DaemonThread {
	...
	public static void main(String[] args) {
		...
		nt2.notThreadMethod();
		//1번 객체가 작업을 끝내야지만 2번 객체가 실행된다.
		
		
		// 첫번째 독립쓰레드 생성
		YesThread yt1 = new YesThread("1st 쓰레드"); // 이름부여 방법 1
		//yt1.setName("첫번째 쓰레드"); //이름부여 방법 2
		yt1.start();
